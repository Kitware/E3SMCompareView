...
[viewport](viewport.md). If the `area` variable is not present, then an
...
section of the [control panel](control_panel.md) to work properly, the
...
[(abhi.yenpure@kitware.com)](https://www.kitware.com/abhishek-yenpure/) for a
discussion.
